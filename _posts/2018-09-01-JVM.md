...
![2021-04-14_JVM数据运行时](C:\Users\xusj\Git\mzz\xsj34567.github.io\_posts\image\2021-04-14_JVM数据运行时.png)
...
场景分析：（本地设置最大堆内存，VisualVM的HeapDump 功能分析）
