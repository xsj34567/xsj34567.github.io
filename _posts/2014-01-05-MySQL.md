...
> 注意MySQL 版本号问题  select showversion() ，比如 5.7.3 版本有些不支持临时表 With as、isnull 函数等

| MySQL                                                    | Oracle                                                      | 说明        |
| -------------------------------------------------------- | ----------------------------------------------------------- | ----------- |
| isnull                                                   | nvl                                                         | 是否为空    |
| 请用IF或CASE语句代替.<br/>IF语句格式:(expr1,expr2,expr3) | DECODE(iv_sr_status,<br>g_sr_status_com, ld_sys_date, NULL) | IF ELSE判断 |
|                                                          |                                                             |             |

[MySQL 与Oracle函数差异](https://www.studyweb.cn/detail/shujukuqita_227995.html)
