...
| 名称   | 核心                                                         | 优劣                                                         |
| ------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Feign  | Netflix、声明式伪Http<br/>基于Feign注解 和 JAX-RS注解<br/>整合了ribbon，具有负载均的能力<br/>整合了Hystrix，具有快速熔断的能力<br/>通过服务名调用 | 轮询、客户端做负载算法                                       |
...
| 名称     | 核心                                                         | 优劣 |
| -------- | ------------------------------------------------------------ | ---- |
| Kafka    | TCP二进制协议、无事务设计                                    |      |
| RabbitMQ | AMQP(OpenWire、AMQP、MQTT、Kafka、OpenMessage)<br/>协议、支持事务、持久化、<br/>多用于金融行业、可靠性搞 |      |
